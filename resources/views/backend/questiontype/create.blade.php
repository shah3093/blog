    ...
    <div class="row">
        ...
        <div class="col-md-7">
            <div class="card">
                ...
                <form id="addFrm" action="{{route('backend.questiontype.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="type" class="form-control required" value="{{old('name')}}" name="type" placeholder="Question Type"/>
                        </div>
                    </div>
