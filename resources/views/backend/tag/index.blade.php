        ...
        <div class="card-body">
            <div class="card-title">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="ml-auto text-right">
                            <a href="{{route('backend.tag.create')}}" class="btn btn-sm btn-info">
                ...
                <table id="zero_config" class="table table-striped table-bordered">
                    ...
                    @foreach($tags as $tag)
                        <tr>
                            ...
                            <td>{{$tag->created}}</td>
                            <td>
                                <a href="{{route('backend.tag.edit',['tag'=>$tag->id])}}" type="button" class="btn btn-primary ">
                                    <i class="mdi mdi-table-edit"></i>
                                </a>
                                <form class="deletedatafrm btn" action="{{route('backend.tag.destroy',['tag'=>$tag->id])}}" method="POST">
                                    @method('DELETE')
                                    @csrf
