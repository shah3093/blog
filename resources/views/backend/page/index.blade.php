        ...
        <div class="card-body">
            <div class="card-title">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="ml-auto text-right">
                            <a href="{{route('backend.page.create')}}" class="btn btn-sm btn-info">
                ...
                <table id="zero_config" class="table table-striped table-bordered">
                    ...
                    @foreach($pages as $page)
                        <tr>
                            ...
                            <td>{{$page->created}}</td>
                            <td>
                                <a href="{{route('backend.page.edit',['page'=>$page->id])}}" type="button" class="btn btn-primary ">
                                    <i class="mdi mdi-table-edit"></i>
                                </a>
                                <form class="deletedatafrm btn" action="{{route('backend.page.destroy',['page'=>$page->id])}}" method="POST">
                                    @method('DELETE')
                                    @csrf
