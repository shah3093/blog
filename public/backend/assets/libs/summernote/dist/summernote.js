...
(function (global, factory) {
    ...
    var Editor = /** @class */ (function () {
      ...
      */
         ...
         * @type command
         */
        Editor.prototype.trash = function () {
            var rng = this.createRange();
            if (rng.isOnAnchor()) {
                ...
                rng.select();
                this.beforeCommand();
                // console.log(rng.select().ec.href);
                deleteFile(rng.select().ec.href);
        ...
        function deleteFile(text) {
            $.post(deletefilemethodurl, {'text': text,'_token':_token}, function (re) {
                console.log(re);
            });
        }
        /**
    ...
    var Buttons = /** @class */ (function () {
        ...
        Buttons.prototype.addLinkPopoverButtons = function () {
            ...
            this.context.memo('button.trash', function () {
                return _this.button({
                    contents: _this.ui.icon(_this.options.icons.trash),
                    tooltip: _this.lang.link.trash,
                    click: _this.context.createInvokeHandler('editor.trash')
                }).render();
            });
